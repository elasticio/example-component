...
// this action uses the Lookup Object (at most 1) by ID design pattern in the OIH standard:
...
/**
 * This action has a configuration field linkedObjectsToPopulate.
...
exports.getLinkedObjectsModel = async function getLinkedObjectsModel(cfg) {
  ...
  // does this need error handling? how does the platform handle the error?
  const relationships = await client.makeRequest({
    url: `${cfg.objectType}/relationships`,
    method: 'GET',
  });
